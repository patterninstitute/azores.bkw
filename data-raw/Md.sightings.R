...
path <- here::here("data-raw/Md_Data.xlsx")
md_data_raw <- readxl::read_xlsx(path, col_names = TRUE, skip = 1L, sheet = 4)
...
usethis::use_data(md.ethology, overwrite = TRUE)
usethis::use_data(md.pod_age_composition, overwrite = TRUE)
usethis::use_data(md.reaction_to_boat, overwrite = TRUE)
usethis::use_data(md.sightings, overwrite = TRUE)
