...
path <- here::here("data-raw/Ha_Data.xlsx")
ha_data_raw <- readxl::read_xlsx(path, col_names = TRUE, skip = 1L, sheet = 4)
...
usethis::use_data(ha.ethology, overwrite = TRUE)
usethis::use_data(ha.pod_age_composition, overwrite = TRUE)
usethis::use_data(ha.reaction_to_boat, overwrite = TRUE)
usethis::use_data(ha.sightings, overwrite = TRUE)
