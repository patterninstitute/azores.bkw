...
path <- here::here("data-raw/Me_Data.xlsx")
me_data_raw <- readxl::read_xlsx(path, col_names = TRUE, skip = 1L, sheet = 4)
...
usethis::use_data(me.ethology, overwrite = TRUE)
usethis::use_data(me.pod_age_composition, overwrite = TRUE)
usethis::use_data(me.reaction_to_boat, overwrite = TRUE)
usethis::use_data(me.sightings, overwrite = TRUE)
